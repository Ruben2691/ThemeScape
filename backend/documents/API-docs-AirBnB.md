...
* Request
  * Method: GET
  * Route path: /reviews/current/:spotid
  * Body: none
...
* Request
  * Method: DELETE
  * Route path:/:user/:spot/booking/:id
  * Body: none
